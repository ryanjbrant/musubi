...
{{tr('video_payments') }} {{Setting::get('currency')}} {{total_moderator_video_revenue()}} 
...
<div id="help-content" style="display: none">
    ...
    <ul class="popover-list">
        <li><b>{{tr('amount')}} - </b> Total amount paid by user</li>
        <li><b>{{tr('admin_amount')}} - </b> Admin Commission amount for the payment </li>
        <li><b>{{tr('my_commission')}} - </b> Your earnings for the payment </li>
        <li><b>{{tr('reason')}} - </b> Payment Failure reasons </li>
        <li><b>{{tr('status')}} - </b> Payment status - Paid, UnPaid </li>
    </ul>
