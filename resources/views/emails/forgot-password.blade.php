              ...
              <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer">
                ...
                <![endif]-->
                            ...
                            <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                              <tbody>
                                <tr>
                                  <td class="mcnTextContent" style="padding: 0px 18px 9px; font-family: &quot;Helvetica Neue&quot;,Helvetica,Arial,Verdana,sans-serif; font-style: normal; font-weight: normal; line-height: 150%; text-align: center;" valign="top"><h2 class="null" style="text-align: center;"><span style="font-size:24px"><span style="color: #FFFFFF;"><span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif">Your Forgot Password request has been Accepted. Please find the password below to login,</span></span></span></h2>
                                  <br>
                                  </td>
                                </tr>
                              </tbody>
                              ...
                              <tbody>
                                <tr>
                                  <td class="mcnButtonContent" style="font-family: &quot;Helvetica Neue&quot;,Helvetica,Arial,Verdana,sans-serif; font-size: 14px; padding: 15px;" valign="middle" align="center">
                                        ...
                                        <p style="color: #fff;">Your Email : @if(isset($email_data))  @if(isset($email_data['email'])) <span style="color: #fff !important;">{{$email_data['email']}}</span>@endif @endif</p>

                                        <p style="color: #fff">Your Password : @if(isset($email_data))  @if(isset($email_data['email'])){{$email_data['password']}} @endif @endif</p>
