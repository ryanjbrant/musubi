                              ...
                              <tbody>
                                <tr>
                                    <td class="mcnButtonContent" style="font-family: &quot;Helvetica Neue&quot;,Helvetica,Arial,Verdana,sans-serif; font-size: 14px; padding: 15px;" valign="middle" align="center">
                                        ...
                                        <a class="mcnButton " title="JOIN FREE FOR MONTH"  target='_blank' href="{{Setting::get('ANGULAR_SITE_URL')}}" style="font-weight: normal;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;padding-right: 20px">
                                            Visit our Website
                                        </a>
              ...
              <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer">
                ...
                <![endif]-->
                            ...
                            <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                              <tbody>
                                <tr>
                                  <td class="mcnTextContent" style="padding: 0px 18px 9px; font-family: &quot;Helvetica Neue&quot;,Helvetica,Arial,Verdana,sans-serif; font-style: normal; font-weight: normal; line-height: 150%; text-align: center;" valign="top"><h2 class="null" style="text-align: center;"><span style="font-size:24px"><span style="color: #FFFFFF;"><span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif">"Congratulations! Admin has made you a Content Creator. Please use the link and details below to login and upload Content"</span></span></span></h2>
                                  <br>
                                  </td>
                                </tr>
                              </tbody>
                      ...
                      <tbody class="mcnButtonBlockOuter">
                        <tr>
                          <td style="padding-top:0; padding-right:25%; padding-bottom:18px; padding-left:34%;" class="mcnButtonBlockInner" valign="top" align="left"><table class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;border: 3px dotted #BF0B00;" cellspacing="0" cellpadding="0" border="0">
                              <tbody>
                                <tr>
                                    <td class="mcnButtonContent" style="font-family: &quot;Helvetica Neue&quot;,Helvetica,Arial,Verdana,sans-serif; font-size: 14px; padding: 15px;" valign="middle" align="center">

                                        <a class="mcnButton " title="Content Creator Login"  target='_blank' href="{{route('moderator.dashboard')}}" style="font-weight: normal;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">
