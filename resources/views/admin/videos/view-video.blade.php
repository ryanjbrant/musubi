...
<div id="help-content" style="display: none">
    ...
    <ul class="popover-list">
        <li><b>Redeems - </b> Moderator earnings based on the watch count</li>
        <li><b>Viewers Count - </b> Total watch count </li>
        <li><b>{{tr('ppv_created_by')}} - </b> Admin/Moderator Names </li>
    </ul>
                    ...
                    <section id="revenue-section" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <p class="ppv-amount-label">
                                    <b>{{tr('admin_amount')}}: </b>
                                    <label class="text-green">{{Setting::get('currency')}} {{$video->admin_amount}}</label>
                                </p>
                            ...
                            <div class="col-md-4">
                                ...
                                <p class="ppv-amount-label">
                                    <b>{{tr('moderator_amount')}}: </b>
                                    <label class="text-blue">
                                        {{Setting::get('currency')}} {{$video->user_amount}}
                                    </label>
                                </p>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="box-body box-profile">
                                    ...
                                    <ul class="list-group list-group-unbordered">
                                        ...
                                        <li class="list-group-item">
                                          <b><i class="fa fa-eye margin-r-5"></i>{{tr('viewers_cnt')}}</b> <a class="pull-right">{{$video->watch_count ? number_format_short($video->watch_count) : 0}}</a>
                                        </li>

                                        <li class="list-group-item">
                                          <b><i class="fa fa-money margin-r-5"></i>{{tr('redeems')}}</b> <a class="pull-right">{{Setting::get('currency')}} {{$video->redeem_amount ? $video->redeem_amount : 0}}</a>
                                        </li>

                                        <li class="list-group-item">

                                            <b><i class="fa fa-upload margin-r-5"></i>{{tr('uploaded_by')}}</b>
                                            
                                            @if(is_numeric($video->uploaded_by))

                                                <a class="pull-right" href="{{route('admin.moderator.view',$video->uploaded_by)}}">{{$video->moderator ? $video->moderator->name : ''}}</a>


                                            @else 

                                                <a class="pull-right">{{$video->uploaded_by}}</a>
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <b><i class="fa fa-upload margin-r-5"></i>{{tr('ppv_created_by')}}</b>

                                            @if(is_numeric($video->ppv_created_by))

                                                <a class="pull-right" href="{{route('admin.moderator.view',$video->ppv_created_by)}}">
                                                    {{moderator_details($video->ppv_created_by , 'name')}}
                                                </a>


                                            @else 

                                                <a class="pull-right">{{$video->ppv_created_by}}</a>
