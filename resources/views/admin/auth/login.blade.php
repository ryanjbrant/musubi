        ...
        <form class="form-layout" role="form" method="POST" action="{{ url('/admin/login') }}">
            ...
            <div class="form-inputs">
                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                    ...
                    <input type="email" class="form-control input-lg" value="{{Setting::get('demo_admin_email')}}" name="email" placeholder="{{tr('email')}}">
                ...
                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                    ...
                    <input type="password" class="form-control input-lg" value="{{Setting::get('demo_admin_password')}}" name="password" placeholder="{{tr('password')}}" >
