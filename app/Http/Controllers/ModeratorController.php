...
class ModeratorController extends Controller
{
    ...
    public function dashboard() {
        ...
        $video_payment = total_moderator_video_revenue();
                ...
                if ($video->video_resolutions) {
                    ...
                    if ($main_video_url) {
                        ...
                        if (file_exists($inputFile)) {
                            ...
                            dispatch(new CompressVideo($inputFile, $local_url, MAIN_VIDEO, $video->id, $file_name,0));
                    ...
                    if ($trailer_video_url) {
                        if ($trailer_video) {
                            ...
                            if (file_exists($inputFile)) {
                                ...
                                dispatch(new CompressVideo($inputFile, $local_url, TRAILER_VIDEO, $video->id,$file_name,0));
    ...
    public function video_payments() {
        ...
        return view('moderator.payments.video-payments')->with('data' , $payments)->withPage('revenue')->with('sub_page','video-payments'); 
    }
